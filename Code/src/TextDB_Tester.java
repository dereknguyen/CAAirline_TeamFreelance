...
public class TextDB_Tester
{
    public static void main(String[] args)
    {
        ...
        db.addCustomerAccount("nparra", "test","Nick", "Parra");
        db.addCustomerAccount("nparra2", "test", "Hi", "World");
        db.addCustomerAccount("nparra3", "test", "Hello", "Again");
        ...
        db.editCustomer("nparra", "test", "New", "Name");
